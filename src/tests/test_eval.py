...
nuscenes_eval.override_constants([0], ["dummy_attr"])
pred_nusc_boxes = nuscenes_eval.convert_pred_to_nusc_boxes(pred)
gt_nusc_boxes = nuscenes_eval.convert_gt_to_nusc_boxes(gt)
